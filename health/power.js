            ...
            let pop = `<div class="card">
                          <div class="card-body ">
                              <h3 class="d-flex align-items-center" style="color: blue; flex-direction: column;">
                                  คะแนนพลังตัวตน ${((sumIdentity)*100/45)} %
                                  </h3>
                                  <table id="customers1">
                                      <tr>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <h3 class="d-flex align-items-center" style="color: blue; flex-direction: column;">
                                    คะแนนพลังครอบครัว ${sumIdentity} %</h3>
                                    <table id="customers1">
                                        <tr>
                                            <th>ร้อยละของคะแนน</th>
                         ...
                         <div class="card">
                           <div class="card-body ">
                               <h3 class="d-flex align-items-center" style="color: blue; flex-direction: column;">
                                   คะแนนพลังสร้างปัญญา ${sumIdentity} %</h3>
                                   <table id="customers1">
                                       <tr>
                                           <th>ร้อยละของคะแนน</th>
                        ...
                        <div class="card">
                          <div class="card-body">
                              <h3 class="d-flex align-items-center" style="color: blue; flex-direction: column;">
                                  คะแนนพลังเพื่อนและกิจกรรม ${sumIdentity} %</h3>
                                  <table id="customers1">
                                      <tr>
                                          <th>ร้อยละของคะแนน</th>
