    ...
    fetch('https://smartcity-pakpoon-api.herokuapp.com/dementia/adddementia', {
      ...
      Swal.fire({
        ...
        let texts = [
          ...
          <td class="radio" style="color: #006600 ;">สมมรถภาพทางสมองอยู่ในระดับค่อนข้างต่ำ ควรเข้ารับคำแนะนำเพื่อเพิ่มสมรรถภาพทางสมอง</td>
      </tr>`,

          `<tr>
          <td class="radio">20 - 29 คะแนน</td>
          <td class="radio" style="color: #003399;">สมมรถภาพทางสมองอยู่ในระดับฑ์ปานกลาง ควรเข้ารับคำแนะนำเพื่อเพิ่มสมรรถภาพทางสมอง</td>
      </tr>`,
          `<tr>
